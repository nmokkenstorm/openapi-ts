...
import { type DefaultError, type InfiniteData, infiniteQueryOptions, queryOptions, type UseMutationOptions, useQuery, type UseQueryOptions } from '@tanstack/react-query';
...
export const useExportQuery = (options?: Options<ExportData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...exportOptions(options), ...queryOptions });
...
export const useApiVVersionODataControllerCountQuery = (options?: Options<ApiVVersionODataControllerCountData>, queryOptions?: Partial<Omit<UseQueryOptions<ApiVVersionODataControllerCountResponse, DefaultError, ApiVVersionODataControllerCountResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...apiVVersionODataControllerCountOptions(options), ...queryOptions });
...
export const useGetCallWithoutParametersAndResponseQuery = (options?: Options<GetCallWithoutParametersAndResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getCallWithoutParametersAndResponseOptions(options), ...queryOptions });
...
export const useGetCallWithOptionalParamQuery = (options: Options<GetCallWithOptionalParamData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getCallWithOptionalParamOptions(options), ...queryOptions });
...
export const useCallWithDefaultParametersQuery = (options?: Options<CallWithDefaultParametersData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithDefaultParametersOptions(options), ...queryOptions });
...
export const useDuplicateName2Query = (options?: Options<DuplicateName2Data>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...duplicateName2Options(options), ...queryOptions });
...
export const useCallWithNoContentResponseQuery = (options?: Options<CallWithNoContentResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<CallWithNoContentResponseResponse, DefaultError, CallWithNoContentResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithNoContentResponseOptions(options), ...queryOptions });
...
export const useDummyAQuery = (options?: Options<DummyAData>, queryOptions?: Partial<Omit<UseQueryOptions<DummyAResponse, DefaultError, DummyAResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyAOptions(options), ...queryOptions });
...
export const useDummyBQuery = (options?: Options<DummyBData>, queryOptions?: Partial<Omit<UseQueryOptions<DummyBResponse, DefaultError, DummyBResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyBOptions(options), ...queryOptions });
...
export const useCallWithResponseQuery = (options?: Options<CallWithResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<CallWithResponseResponse, DefaultError, CallWithResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithResponseOptions(options), ...queryOptions });
...
export const useCollectionFormatQuery = (options: Options<CollectionFormatData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...collectionFormatOptions(options), ...queryOptions });
...
export const useTypesQuery = (options: Options<TypesData>, queryOptions?: Partial<Omit<UseQueryOptions<TypesResponse, DefaultError, TypesResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...typesOptions(options), ...queryOptions });
...
export const useFileResponseQuery = (options: Options<FileResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<FileResponseResponse, DefaultError, FileResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...fileResponseOptions(options), ...queryOptions });
...
export const useComplexTypesQuery = (options: Options<ComplexTypesData>, queryOptions?: Partial<Omit<UseQueryOptions<ComplexTypesResponse, DefaultError, ComplexTypesResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...complexTypesOptions(options), ...queryOptions });
...
export const useMultipartResponseQuery = (options?: Options<MultipartResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<MultipartResponseResponse, DefaultError, MultipartResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...multipartResponseOptions(options), ...queryOptions });
