...
import { type DefaultError, type InfiniteData, infiniteQueryOptions, queryOptions, skipToken, type UseMutationOptions, useQuery, type UseQueryOptions } from '@tanstack/react-query';
...
export const exportOptions = (options?: Options<ExportData> | typeof skipToken) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof exportQueryKey>>({
    ...
    queryKey: exportQueryKey(options === skipToken ? undefined : options)
});

export const useExportQuery = (options?: Options<ExportData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...exportOptions(options), ...queryOptions });
...
export const apiVVersionODataControllerCountOptions = (options?: Options<ApiVVersionODataControllerCountData> | typeof skipToken) => queryOptions<ApiVVersionODataControllerCountResponse, DefaultError, ApiVVersionODataControllerCountResponse, ReturnType<typeof apiVVersionODataControllerCountQueryKey>>({
    ...
    queryKey: apiVVersionODataControllerCountQueryKey(options === skipToken ? undefined : options)
});

export const useApiVVersionODataControllerCountQuery = (options?: Options<ApiVVersionODataControllerCountData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<ApiVVersionODataControllerCountResponse, DefaultError, ApiVVersionODataControllerCountResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...apiVVersionODataControllerCountOptions(options), ...queryOptions });
...
export const getApiVbyApiVersionSimpleOperationOptions = (options: Options<GetApiVbyApiVersionSimpleOperationData> | typeof skipToken) => queryOptions<GetApiVbyApiVersionSimpleOperationResponse, GetApiVbyApiVersionSimpleOperationError, GetApiVbyApiVersionSimpleOperationResponse, ReturnType<typeof getApiVbyApiVersionSimpleOperationQueryKey>>({
    ...
    queryKey: getApiVbyApiVersionSimpleOperationQueryKey(options === skipToken ? undefined : options)
});
...
export const useGetCallWithoutParametersAndResponseQuery = (options?: Options<GetCallWithoutParametersAndResponseData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getCallWithoutParametersAndResponseOptions(options), ...queryOptions });
...
export const getCallWithOptionalParamOptions = (options: Options<GetCallWithOptionalParamData> | typeof skipToken) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof getCallWithOptionalParamQueryKey>>({
    ...
    queryKey: getCallWithOptionalParamQueryKey(options === skipToken ? undefined : options)
});
...
// @ts-ignore
{
    ...
    queryKey: getCallWithOptionalParamInfiniteQueryKey(options === skipToken ? undefined : options)
});

export const useGetCallWithOptionalParamQuery = (options: Options<GetCallWithOptionalParamData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getCallWithOptionalParamOptions(options), ...queryOptions });
...
export const useCallWithDefaultParametersQuery = (options?: Options<CallWithDefaultParametersData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithDefaultParametersOptions(options), ...queryOptions });
...
export const useDuplicateName2Query = (options?: Options<DuplicateName2Data> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...duplicateName2Options(options), ...queryOptions });
...
export const useDummyAQuery = (options?: Options<DummyAData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<DummyAResponse, DefaultError, DummyAResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyAOptions(options), ...queryOptions });
...
export const useDummyBQuery = (options?: Options<DummyBData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<DummyBResponse, DefaultError, DummyBResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyBOptions(options), ...queryOptions });
...
export const useCallWithResponseQuery = (options?: Options<CallWithResponseData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<CallWithResponseResponse, DefaultError, CallWithResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithResponseOptions(options), ...queryOptions });
...
export const useCollectionFormatQuery = (options: Options<CollectionFormatData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...collectionFormatOptions(options), ...queryOptions });
...
export const useTypesQuery = (options: Options<TypesData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<TypesResponse, DefaultError, TypesResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...typesOptions(options), ...queryOptions });
...
export const fileResponseOptions = (options: Options<FileResponseData> | typeof skipToken) => queryOptions<FileResponseResponse, DefaultError, FileResponseResponse, ReturnType<typeof fileResponseQueryKey>>({
    ...
    queryKey: fileResponseQueryKey(options === skipToken ? undefined : options)
});

export const useFileResponseQuery = (options: Options<FileResponseData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<FileResponseResponse, DefaultError, FileResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...fileResponseOptions(options), ...queryOptions });
...
export const useComplexTypesQuery = (options: Options<ComplexTypesData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<ComplexTypesResponse, DefaultError, ComplexTypesResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...complexTypesOptions(options), ...queryOptions });
...
export const multipartResponseOptions = (options?: Options<MultipartResponseData> | typeof skipToken) => queryOptions<MultipartResponseResponse, DefaultError, MultipartResponseResponse, ReturnType<typeof multipartResponseQueryKey>>({
    ...
    queryKey: multipartResponseQueryKey(options === skipToken ? undefined : options)
});

export const useMultipartResponseQuery = (options?: Options<MultipartResponseData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<MultipartResponseResponse, DefaultError, MultipartResponseResponse>, 'queryKey' | 'queryFn'>>) => useQuery({ ...multipartResponseOptions(options), ...queryOptions });
