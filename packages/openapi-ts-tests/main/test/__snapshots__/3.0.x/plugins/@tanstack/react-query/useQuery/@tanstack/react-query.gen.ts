...
export const useExportQuery = (options?: Options<ExportData>, queryOptions?: Partial<Omit<ReturnType<typeof exportOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...exportOptions(options), ...queryOptions });
...
export const useApiVVersionODataControllerCountQuery = (options?: Options<ApiVVersionODataControllerCountData>, queryOptions?: Partial<Omit<ReturnType<typeof apiVVersionODataControllerCountOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...apiVVersionODataControllerCountOptions(options), ...queryOptions });
...
export const useGetApiVbyApiVersionSimpleOperationQuery = (options: Options<GetApiVbyApiVersionSimpleOperationData>, queryOptions?: Partial<Omit<ReturnType<typeof getApiVbyApiVersionSimpleOperationOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getApiVbyApiVersionSimpleOperationOptions(options), ...queryOptions });
...
export const useGetCallWithoutParametersAndResponseQuery = (options?: Options<GetCallWithoutParametersAndResponseData>, queryOptions?: Partial<Omit<ReturnType<typeof getCallWithoutParametersAndResponseOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getCallWithoutParametersAndResponseOptions(options), ...queryOptions });
...
export const useGetCallWithOptionalParamQuery = (options: Options<GetCallWithOptionalParamData>, queryOptions?: Partial<Omit<ReturnType<typeof getCallWithOptionalParamOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...getCallWithOptionalParamOptions(options), ...queryOptions });
...
export const useCallWithDefaultParametersQuery = (options?: Options<CallWithDefaultParametersData>, queryOptions?: Partial<Omit<ReturnType<typeof callWithDefaultParametersOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithDefaultParametersOptions(options), ...queryOptions });
...
export const useDuplicateName2Query = (options?: Options<DuplicateName2Data>, queryOptions?: Partial<Omit<ReturnType<typeof duplicateName2Options>, 'queryKey' | 'queryFn'>>) => useQuery({ ...duplicateName2Options(options), ...queryOptions });
...
export const useCallWithNoContentResponseQuery = (options?: Options<CallWithNoContentResponseData>, queryOptions?: Partial<Omit<ReturnType<typeof callWithNoContentResponseOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithNoContentResponseOptions(options), ...queryOptions });
...
export const useCallWithResponseAndNoContentResponseQuery = (options?: Options<CallWithResponseAndNoContentResponseData>, queryOptions?: Partial<Omit<ReturnType<typeof callWithResponseAndNoContentResponseOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithResponseAndNoContentResponseOptions(options), ...queryOptions });
...
export const useDummyAQuery = (options?: Options<DummyAData>, queryOptions?: Partial<Omit<ReturnType<typeof dummyAOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyAOptions(options), ...queryOptions });
...
export const useDummyBQuery = (options?: Options<DummyBData>, queryOptions?: Partial<Omit<ReturnType<typeof dummyBOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyBOptions(options), ...queryOptions });
...
export const useCallWithResponseQuery = (options?: Options<CallWithResponseData>, queryOptions?: Partial<Omit<ReturnType<typeof callWithResponseOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithResponseOptions(options), ...queryOptions });
...
export const useCollectionFormatQuery = (options: Options<CollectionFormatData>, queryOptions?: Partial<Omit<ReturnType<typeof collectionFormatOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...collectionFormatOptions(options), ...queryOptions });
...
export const useTypesQuery = (options: Options<TypesData>, queryOptions?: Partial<Omit<ReturnType<typeof typesOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...typesOptions(options), ...queryOptions });
...
export const useFileResponseQuery = (options: Options<FileResponseData>, queryOptions?: Partial<Omit<ReturnType<typeof fileResponseOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...fileResponseOptions(options), ...queryOptions });
...
export const useComplexTypesQuery = (options: Options<ComplexTypesData>, queryOptions?: Partial<Omit<ReturnType<typeof complexTypesOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...complexTypesOptions(options), ...queryOptions });
...
export const useMultipartResponseQuery = (options?: Options<MultipartResponseData>, queryOptions?: Partial<Omit<ReturnType<typeof multipartResponseOptions>, 'queryKey' | 'queryFn'>>) => useQuery({ ...multipartResponseOptions(options), ...queryOptions });
