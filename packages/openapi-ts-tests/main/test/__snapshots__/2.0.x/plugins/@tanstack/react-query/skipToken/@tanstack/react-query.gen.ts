...
import { type DefaultError, queryOptions, skipToken, type UseMutationOptions, useQuery, type UseQueryOptions } from '@tanstack/react-query';
...
export const useServiceWithEmptyTagQuery = (options?: Options<ServiceWithEmptyTagData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...serviceWithEmptyTagOptions(options), ...queryOptions });
...
export const useCallWithNoContentResponseQuery = (options?: Options<CallWithNoContentResponseData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithNoContentResponseOptions(options), ...queryOptions });
...
export const useDummyAQuery = (options?: Options<DummyAData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyAOptions(options), ...queryOptions });
...
export const useDummyBQuery = (options?: Options<DummyBData> | typeof skipToken, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyBOptions(options), ...queryOptions });
