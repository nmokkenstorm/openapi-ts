...
import { type DefaultError, queryOptions, type UseMutationOptions, useQuery, type UseQueryOptions } from '@tanstack/react-query';
...
export const useServiceWithEmptyTagQuery = (options?: Options<ServiceWithEmptyTagData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...serviceWithEmptyTagOptions(options), ...queryOptions });
...
export const useCallWithNoContentResponseQuery = (options?: Options<CallWithNoContentResponseData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...callWithNoContentResponseOptions(options), ...queryOptions });
...
export const useDummyAQuery = (options?: Options<DummyAData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyAOptions(options), ...queryOptions });
...
export const useDummyBQuery = (options?: Options<DummyBData>, queryOptions?: Partial<Omit<UseQueryOptions<unknown, DefaultError, unknown>, 'queryKey' | 'queryFn'>>) => useQuery({ ...dummyBOptions(options), ...queryOptions });
